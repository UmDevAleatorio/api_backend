...
from core.domain.value_objects import Name, Email, Password, Price, Photo
...
async def test_create_order_success():
    ...
    prod = Product("p1", Name("Brita"), Price(50.0), Photo("http://teste.com/img.jpg"), stock=10, user_id="u1")
